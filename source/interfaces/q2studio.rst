...
Please note, your ``conda`` environment might have a name other than ``qiime2-2017.12``, if you or your system administrator provided one during :doc:`installation of QIIME 2<../install/index>`.
...
.. download::
   :url: https://codeload.github.com/qiime2/q2studio/zip/2017.12.0
   :saveas: q2studio-2017.12.0.zip
   :no-exec:

.. command-block::
   :no-exec:

   unzip q2studio-2017.12.0.zip && rm q2studio-2017.12.0.zip
   cd q2studio-2017.12.0
