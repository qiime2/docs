...
.. download::
   :url: https://codeload.github.com/qiime2/q2studio/zip/2018.2.0
   :saveas: q2studio-2018.2.0.zip
   :no-exec:

.. command-block::
   :no-exec:

   unzip q2studio-2018.2.0.zip && rm q2studio-2018.2.0.zip
   cd q2studio-2018.2.0
