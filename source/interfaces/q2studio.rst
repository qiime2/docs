...
Please note, your ``conda`` environment might have a name other than ``qiime2-2019.1``, if you or your system administrator provided one during :doc:`installation of QIIME 2 <../install/index>`.
...
.. download::
   :url: https://codeload.github.com/qiime2/q2studio/zip/2019.1.0
   :saveas: q2studio-2019.1.0.zip
   :no-exec:

.. command-block::
   :no-exec:

   unzip q2studio-2019.1.0.zip && rm q2studio-2019.1.0.zip
   cd q2studio-2019.1.0
