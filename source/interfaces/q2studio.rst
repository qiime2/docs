...
Please note, your ``conda`` environment might have a name other than ``qiime2-2021.11``, if you or your system administrator provided one during :doc:`installation of QIIME 2 <../install/index>`.
...
.. download::
   :url: https://codeload.github.com/qiime2/q2studio/zip/2021.11.0
   :saveas: q2studio-2021.11.0.zip
   :no-exec:

.. command-block::
   :no-exec:

   unzip q2studio-2021.11.0.zip && rm q2studio-2021.11.0.zip
   cd q2studio-2021.11.0
