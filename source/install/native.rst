...
the QIIME 2 Core 2023.2 distribution within the environment. We **highly**
...
``qiime2-2023.2`` to indicate what QIIME 2 release is installed (i.e.
``2023.2``).
...
.. raw:: html
   ...
   <div class="tabbed">
      ...
      <div class="tab-content">
         ...
         <div id="macOS-intel" class="tab-pane fade">
            <pre>wget https://data.qiime2.org/distro/core/qiime2-2023.2-py38-osx-conda.yml
   conda env create -n qiime2-2023.2 --file qiime2-2023.2-py38-osx-conda.yml</pre>
   <span>OPTIONAL CLEANUP</span>
   <pre>rm qiime2-2023.2-py38-osx-conda.yml</pre>
         </div>
   ...
   <pre>rm qiime2-2023.2-py38-osx-conda.yml</pre>
         ...
         <div id="linux" class="tab-pane fade">
            <pre>wget https://data.qiime2.org/distro/core/qiime2-2023.2-py38-linux-conda.yml
   conda env create -n qiime2-2023.2 --file qiime2-2023.2-py38-linux-conda.yml</pre>
   <span>OPTIONAL CLEANUP</span>
   <pre>rm qiime2-2023.2-py38-linux-conda.yml</pre>
         </div>
...
or deactivated, QIIME 2 2023.2 can be activated (or reactivated) by running
