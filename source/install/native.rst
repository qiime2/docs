...
the QIIME 2 Core 2021.10 distribution within the environment. We **highly**
...
``qiime2-2021.10`` to indicate what QIIME 2 release is installed (i.e.
``2021.10``).
   ...
   <div class="tabbed">
      ...
      <div class="tab-content">
         ...
         <div id="macOS" class="tab-pane fade">
            <pre>wget https://data.qiime2.org/distro/core/qiime2-2021.10-py38-osx-conda.yml
   conda env create -n qiime2-2021.10 --file qiime2-2021.10-py38-osx-conda.yml
   # OPTIONAL CLEANUP
   rm qiime2-2021.10-py38-osx-conda.yml</pre>
         </div>
         <div id="linux" class="tab-pane fade">
            <pre>wget https://data.qiime2.org/distro/core/qiime2-2021.10-py38-linux-conda.yml
   conda env create -n qiime2-2021.10 --file qiime2-2021.10-py38-linux-conda.yml
   # OPTIONAL CLEANUP
   rm qiime2-2021.10-py38-linux-conda.yml</pre>
         </div>
         <div id="wsl" class="tab-pane fade">
            <pre># These instructions are identical to the Linux (64-bit) instructions
   wget https://data.qiime2.org/distro/core/qiime2-2021.10-py38-linux-conda.yml
   conda env create -n qiime2-2021.10 --file qiime2-2021.10-py38-linux-conda.yml
   # OPTIONAL CLEANUP
   rm qiime2-2021.10-py38-linux-conda.yml</pre>
         </div>
...
or deactivated, QIIME 2 2021.10 can be activated (or reactivated) by running
