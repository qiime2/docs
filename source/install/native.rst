...
the QIIME 2 Core 2022.11 distribution within the environment. We **highly**
...
``qiime2-2022.11`` to indicate what QIIME 2 release is installed (i.e.
``2022.11``).
...
.. raw:: html
   ...
   mamba env create -n qiime2-2022.11 --file qiime2-2022.11-py38-osx-conda.yml</pre>
   ...
   mamba env create -n qiime2-2022.11 --file qiime2-2022.11-py38-linux-conda.yml</pre>
   <span>OPTIONAL CLEANUP</span>
...
or deactivated, QIIME 2 2022.11 can be activated (or reactivated) by running
