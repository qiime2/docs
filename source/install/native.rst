   ...
   <div class="tabbed">
      ...
      <div class="tab-content">
         ...
         <div id="macOS" class="tab-pane fade">
            <pre>wget https://data.qiime2.org/distro/core/qiime2-2019.10-py36-osx-conda.yml
   conda env create -n qiime2-2019.10 --file qiime2-2019.10-py36-osx-conda.yml
   # OPTIONAL CLEANUP
   rm qiime2-2019.10-py36-osx-conda.yml</pre>
            <div class="alert alert-warning">
              ...
              <pre>Disabling SSL due to encountered errors.</pre>
               ...
               <a href="https://data.qiime2.org/distro/core/qiime2-2019.10-py36-osx-conda.yml">
         ...
         <div id="linux" class="tab-pane fade">
            <pre>wget https://data.qiime2.org/distro/core/qiime2-2019.10-py36-linux-conda.yml
   conda env create -n qiime2-2019.10 --file qiime2-2019.10-py36-linux-conda.yml
   # OPTIONAL CLEANUP
   rm qiime2-2019.10-py36-linux-conda.yml</pre>
            <div class="alert alert-warning">
               If you encounter this error with wget:
              <pre>Disabling SSL due to encountered errors.</pre>
               you can download the file by clicking directly on this link:<br>
               <a href="https://data.qiime2.org/distro/core/qiime2-2019.10-py36-linux-conda.yml">
