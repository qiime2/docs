...
the QIIME 2 Core 2021.4 distribution within the environment. We **highly**
...
``qiime2-2021.4`` to indicate what QIIME 2 release is installed (i.e.
``2021.4``).
...
or deactivated, QIIME 2 2021.4 can be activated (or reactivated) by running
