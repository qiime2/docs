...
.. - `Silva 138 99% OTUs full-length sequences <https://data.qiime2.org/2021.8/common/silva-138-99-nb-classifier.qza>`_ (MD5: ``TBD``)
.. - `Silva 138 99% OTUs from 515F/806R region of sequences <https://data.qiime2.org/2021.8/common/silva-138-99-515-806-nb-classifier.qza>`_ (MD5: ``TBD``)
