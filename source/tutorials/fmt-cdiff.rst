...
In this data set, no continuous sample metadata columns (e.g., ``animations_gradient``) are correlated with alpha diversity, so we won't test for those associations here. If you're interested in performing those tests (for this data set, or for others), you can use the ``qiime diversity alpha-correlation`` command.
...
.. command-block::
   ...
   qiime diversity beta-group-significance \
     ...
     --m-metadata-file sample-metadata.tsv \
     --m-metadata-column disease_stat \
     --o-visualization core-metrics-results/unweighted-unifrac-disease-stat-group-significance.qzv \
     --p-pairwise
...
.. command-block::
   ...
   qiime composition ancom \
     ...
     --m-metadata-file sample-metadata.tsv \
     --m-metadata-column animations_subject \
     --o-visualization ancom-animations_subject.qzv
