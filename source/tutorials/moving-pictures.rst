...
.. question::
    When grouping samples by "BodySite" and viewing the alpha rarefaction plot for the "observed_otus" metric, which body sites (if any) do we seem to have observed the full diversity of? How many sequence variants appear to be present in those body sites?
...
.. download::
   :url: https://data.qiime2.org/2017.10/common/gg-13-8-99-515-806-nb-classifier.qza
...
.. _sample metadata: https://data.qiime2.org/2017.10/tutorials/moving-pictures/sample_metadata
