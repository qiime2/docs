...
You can learn more about the different `QIIME 2 interfaces <https://docs.qiime2.org/2023.9/interfaces/>`__.
...
-  **Test for differences between samples**, through differential abundance or distribution testing: PERMANOVA, ANOSIM, ANCOM, and ANCOM-BC are some of the relevant methods which are available in QIIME 2. PERMANOVA and ANOSIM can be done with the :doc:`beta-group-significance <../plugins/available/diversity/beta-group-significance/>` method in the ``diversity`` plugin, and ANCOM and ANCOM-BC are available in the :doc:`composition <../plugins/available/composition/index>` plugin.
