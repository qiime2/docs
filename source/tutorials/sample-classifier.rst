...
.. hint:: Looking for documentation on individual plugin actions? See the q2-sample-classifier :doc:`API documentation <../plugins/available/sample-classifier/index>`.
